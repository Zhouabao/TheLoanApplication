package com.yuzhua.theloanapplication.util;
...
*//*        oks.setComment("我是测试评论文本");*//*
    ...
    static class ShareContentCustomizeDemo implements ShareContentCustomizeCallback {
        ...
        public void onShare(Platform platform, Platform.ShareParams paramsToShare) {
            ...
            if (QQ.NAME.equals(platform.getName())) {
                ...
                paramsToShare.setSite(c.getString(com.yuzhua.universalinvinciblesdk.R.string.app_name));
                if (!TextUtils.isEmpty(map.get("pic"))) {
                    paramsToShare.setImagePath(map.get("pic"));
                }
                if (!TextUtils.isEmpty(pubText)) {
     ...
     * 第三方登录
     *
     * @param platform                    QQ.NAME  Wechat.NAME  SinaWeibo.NAME
